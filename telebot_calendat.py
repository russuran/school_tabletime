...
class Calendar:
    ...
    def create_calendar(
        ...
        calendar_callback = CallbackData(name, "action", "year", "month", "day", "function")
        data_ignore = calendar_callback.new("IGNORE", year, month, function, "!")
        data_months = calendar_callback.new("MONTHS", year, month, function, "!")
        ...
        keyboard.add(
            InlineKeyboardButton(
                "<",
                callback_data=calendar_callback.new("PREVIOUS-MONTH", year, month, function, "!"),
            ),
            InlineKeyboardButton(
                "Cancel",
                callback_data=calendar_callback.new("CANCEL", year, month, function, "!"),
            ),
            InlineKeyboardButton(
                ">", callback_data=calendar_callback.new("NEXT-MONTH", year, month, function, "!")
            ),
        )
